        ...
        <Row style={{ marginBottom: '15px' }}>
            ...
            <Row>
                {sleeping ? (
                    ...
                    <div style={{ position: 'relative' }}>
                        {camera == 1 && <HLSPlayer src="https://gpupdate.thilenius.com/stream/camera1/index.m3u8" />}
                        {camera == 2 && <HLSPlayer src="https://gpupdate.thilenius.com/stream/camera2/index.m3u8" />}
                    </div>
                )}
            </Row>
